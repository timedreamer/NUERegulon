# This script identifies NxTime genes for the maize time-course data using edge.
...
write_tsv(result_df, here("result", "DEgenes", "zma_NxTgenes_df5_edge.tsv"))
