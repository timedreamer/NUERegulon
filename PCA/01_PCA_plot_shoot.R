# This scirpt plots the PCA plot for the maize time-course data.
...
## Save as pdf
pdf(here("result", "pca", paste0("mts_shoot_pca_all_PCAtools_", 
                                 Sys.Date(),".pdf")
), width = 7, height = 5)
p1
dev.off()

pdf(here("result", "pca", paste0("mts_shoot_pca_all_PCAtools_eigencorplot_", 
                                 Sys.Date(),".pdf")
), width = 8, height = 3.5)
p4
dev.off()
